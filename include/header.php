      ...
      <div class="tp-offcanvas-wrapper">
         <div class="tp-offcanvas-top d-flex align-items-center justify-content-between">
            <div class="tp-offcanvas-logo">
               <a href="index.php">
                  <img class="logo-1" src="assets/img/logo/logo.png" alt="AEC Logo">
                  <img class="logo-2" src="assets/img/logo/logo-white.png" alt="AEC Logo">
               </a>
            </div>
         ...
         <div class="tp-offcanvas-main">
            <div class="tp-offcanvas-content">
               <h3 class="tp-offcanvas-title">Welcome to AEC!</h3>
               <p>Join the Asian Education Coalition to build a unified, future-ready educational framework across Asia.</p>
            </div>
               ...
               <div class="row gx-2">
                  <div class="col-md-3 col-3">
                     <div class="tp-offcanvas-gallery-img fix">
                        <a href="#"><img src="assets/img/home-02/hero/1.png" alt="AEC Education"></a>
                     </div>
                  </div>
                  <div class="col-md-3 col-3">
                     <div class="tp-offcanvas-gallery-img fix">
                        <a href="#"><img src="assets/img/home-02/hero/2.png" alt="AEC Collaboration"></a>
                     </div>
                  </div>
                  <div class="col-md-3 col-3">
                     <div class="tp-offcanvas-gallery-img fix">
                        <a href="#"><img src="assets/img/home-02/hero/3.png" alt="AEC Innovation"></a>
                     </div>
                  </div>
                  <div class="col-md-3 col-3">
                     <div class="tp-offcanvas-gallery-img fix">
                        <a href="#"><img src="assets/img/home-02/hero/4.png" alt="AEC Leadership"></a>
                     </div>
                  </div>
               </div>
            </div>
            <div class="tp-offcanvas-contact">
               ...
               <ul>
                  <li><a href="tel:+918400700199">+91 84007 00199</a></li>
                  <li><a href="mailto:info@aecthinktank.com">info@aecthinktank.com</a></li>
                  <li><a href="#">New Delhi, India</a></li>
               </ul>
            </div>
            <div class="tp-offcanvas-social">
               <h3 class="tp-offcanvas-title sm">Follow AEC</h3>
               <ul>
                  <li>
                     <a href="#">
