            ...
            <div class="tp-footer-2-area black-bg pt-100 pb-20">
               <div class="container container-1480">
                  <div class="row">
                     ...
                     <div class="col-xl-1 col-lg-3 col-md-6 mb-50">
                     ...
                     <div class="col-xl-4 col-lg-5 col-md-6 mb-50">
                        <div class="tp-footer-2-widget footer-col-2-3">
                           ...
                           <div class="tp-footer-2-contact-item">
                              <span><a href="#" target="_blank">New Delhi, India</a></span>
                           </div>
                           <div class="tp-footer-2-contact-item">
                              <span><a href="tel:+918400700199">P: +91 84007 00199</a></span>
                           </div>
                           <div class="tp-footer-2-contact-item">
                              <span><a href="mailto:info@aecthinktank.com">E: info@aecthinktank.com</a></span>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="row align-items-center">
                     <div class="col-xl-4 col-lg-5">
                        <div class="tp-copyright-2-left text-center text-lg-start">
                           <p>All rights reserved — <?php echo date('Y'); ?> © Asian Education Coalition</p>
                        </div>
                     </div>
