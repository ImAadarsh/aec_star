...
<head>
   ...
   <title>Join AEC - Asian Education Coalition</title>
   <meta name="description" content="Join the Asian Education Coalition (AEC) to be part of a collaborative network of educators, schools, and EdTech leaders across Asia.">
                     ...
                     <div class="col-xl-6 col-lg-8">
                        <div class="tp-login-wrapper">
                           <div class="tp-login-top text-center mb-30">
                              <h3 class="tp-login-title">Join AEC</h3>
                           </div>
                           <div class="tp-login-option">
                              <div class="tp-login-mail text-center mb-40">
                                 <p>Join the Asian Education Coalition<a href="#">Now</a></p>
                              </div>
                              <div class="tp-login-input-wrapper">
                                 ...
                                 <div class="tp-login-input-box">
                                    ...
                                    <div class="tp-login-input">
                                       <input id="email" type="email" placeholder="aec@mail.com">
                                    </div>
                                 </div>
                                 <div class="tp-login-input-box">
                                    <div class="tp-login-input-title">
                                 ...
                                 <div class="tp-login-input-box">
                                    ...
                                    <div class="tp-login-input">
                                       <input id="text" type="text" placeholder="Organization">
                                    </div>
                                 </div>
                                 <div class="tp-login-input-box">
                                    <div class="tp-login-input-title">
                                    ...
                                    <div class="tp-login-input">
                                       <input id="text" type="text" placeholder="Country">
                                    </div>
                                 </div>
                              ...
                              <div class="tp-login-suggetions d-sm-flex align-items-center justify-content-between mb-20">
                                 <div class="tp-login-remeber">
                                    ...
                                    <label for="remeber">I accept the terms of the Service & Privacy Policy.</label>
                                 </div>
                              </div>
                              <div class="tp-login-bottom">
                                 <a href="register.php" class="tp-login-btn w-100">Join Now</a>
                              </div>
                           </div>
                        </div>
                     </div>
